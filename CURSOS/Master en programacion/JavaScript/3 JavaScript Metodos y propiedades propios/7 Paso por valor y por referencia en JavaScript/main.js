...
//Los tipos cimpuestos (Arrays y objetos) tienen su paso por referencia
...
// Romper el paso pór referencia 

// concat

let marcasEuropeas = ['W', 'Renault', 'Audi'];

let marcasSeleccionadas = marcasEuropeas.concat();

marcasSeleccionadas.push('Toyota','Suburu');
